...
# -------------------------------
# Plot 4 Collection
# set up a 2 X 2 matrix of graphs
# -------------------------------
png("plot4.png")
...
plot(myPower2$Global_active_power,col="Black", axes=F, main="",xlab="",ylab="Global Active Power", type="l")
axis(2)
...
myLabels <- c(unique(myPower2$day) ,"Sat")
plot(myPower2$Voltage,col="Black", axes=F, main="",xlab="datetime",ylab="Voltage", type="l")
axis(2)
axis(1, at= seq(0,2880, by=1440), labels=myLabels)
box()
...
# Plot 3/4
plot(myPower2$Sub_metering_1,col="Black", axes=F, main="",xlab="",ylab="Energy sub metering", type="l")
axis(2)
axis(1, at= seq(0,2880, by=1440), labels=myLabels)
...
# Note that in this system lwd= < 1 e.g. lwd=0.8 has no effect 
# to precisely #match the plots provided

myLabels <- c(unique(myPower2$day) ,"Sat")
#    c("Thur","Fri","Sat")
plot(myPower2$Global_reactive_power,col="Black", axes=F, main="",xlab="datetime",ylab="Global_reactive_power", type="l")
axis(2)
axis(1, at= seq(0,2880, by=1440), labels=myLabels)
box()
dev.off()
...
# Reset Graphics system to one rwo and one col for graphs
par(mfrow= c(1,1))
